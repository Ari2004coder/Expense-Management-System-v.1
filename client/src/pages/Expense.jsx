...
import AnalyticsForExpense from '../components/analyticsForExpensePage/AnalyticsForExpense';
...
const [transcationDetailsForanalytic,setTranscationDetailsForanalytic]=useState([])
  ...
  const getDetalisforanalytics=async ()=>{
     try {
      ...
      console.log(res.data);
      setTranscationDetailsForanalytic(res.data)
      setloading(false);
    } catch (error) {
      ...
      <Layout>
        ...
        {loading && (
          <div className='w-full flex justify-center items-center'>
            ...
            <AnalyticsForExpense value={transcationDetailsForanalytic}/>
